...
import { Check, AlertCircle, Lock, Unlock, RefreshCw, ChevronDown, ChevronUp } from 'lucide-react';
  ...
  return (
    <div className="w-full">
      ...
      <button
        ...
        className="w-full flex items-center gap-3 p-3 rounded-xl bg-base-200 border border-base-300 hover:bg-base-300 transition-colors"
      >
        <span className="font-semibold text-base-content">View Prompt</span>
